...
class ViewPromotionBody extends StatefulWidget {
  final String docId;
  const ViewPromotionBody({Key? key, required this.docId}) : super(key: key);
  @override
  State<ViewPromotionBody> createState() =>
      _ViewPromotionBodyState(docId: this.docId);
}

class _ViewPromotionBodyState extends State<ViewPromotionBody> {
  String docId;
  _ViewPromotionBodyState({required this.docId});
  @override
  void initState() {
    super.initState();
  }
